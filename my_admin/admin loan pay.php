...
while (oci_fetch($s)) {
		...
		$loanpayid=oci_result($s, "LOANPAYID");
	...
	//	echo "details";
?>	
	<a href='admin loan pay details.php?loanpayid=<?php print $loanpayid ;?>' > Detalis </a>
