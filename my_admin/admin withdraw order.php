  ...
  <div id="header2">
		<div id="menu">
			...
			<ul>
              ...
              <li><div id = "now"><a href="admin deposit order.php">Transaction</a></div></li>
...
<div id = "sidebar">
            ...
            <li><a href="admin deposit order.php">Deposit History</a></li>
            <li><a href="admin withdraw order.php">Withdraw History</a></li>
...
// Select Data...
	$sql="select * from withdraw_order";
