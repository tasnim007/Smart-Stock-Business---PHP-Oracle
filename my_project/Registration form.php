...
<h2>Form for registration</h2>
		...
		<form name="regform" id="form2" action="confirmreg.php"  method="POST">	
               ...
               <p>
				...
				<p>
                 ...
                 <p>
				  ...
				  <input type="text" name="occ" id="occ" size="50" />
				</p>
                
                 <p>
				  <label for="mail">Nationality </label>
				  <input type="text" name="nationality" id="nationality" size="50" />
				</p>
                
 <br />
 <br />               
				<p>
					<label for="bo">BO account no</label>
					<input type="text" name="bo" id="bo" size="50" />
				</p>
                
                <p>
					<label for="balance">Account balance </label>
					<input type="text" name="balance" id="balance" size="50" />
				</p>		
